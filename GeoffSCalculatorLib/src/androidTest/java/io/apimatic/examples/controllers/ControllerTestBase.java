...
import io.apimatic.examples.GeoffSCalculatorClient;
...
public class ControllerTestBase {
    ...
    private static GeoffSCalculatorClient client;
     ...
     * @return
     */
    protected static GeoffSCalculatorClient getClient() {
        if(client == null)
            synchronized (clientSync) {
                client = new GeoffSCalculatorClient();
            }
        return client;
    }
}
